...
var io = require('./io-eeb32707.development.cjs.js');
var deferred = require('@redux-saga/deferred');
...
function runCallEffect(env, _ref4, cb, _ref5) {
  ...
  try {
    ...
    if (is.iterator(result)) {
      // resolve iterator
      proc(env, result, task.context, current, io.getMetaInfo(fn), /* isRoot */false, cb);
      return;
    }
    cb(result);
  } catch (error) {
...
function runSaga(_ref, saga) {
  ...
  if (effectMiddlewares) {
    var middleware = io.compose.apply(void 0, effectMiddlewares);
  ...
  return immediately(function () {
    var task = proc(env, iterator, context, effectId, io.getMetaInfo(saga), /* isRoot */true, undefined);
    if (sagaMonitor) {
...
function sagaMiddlewareFactory(_temp) {
  var _ref = _temp === void 0 ? {} : _temp,
    ...
    channel = _ref$channel === void 0 ? stdChannel() : _ref$channel,
    sagaMonitor = _ref.sagaMonitor,
    options = _objectWithoutPropertiesLoose["default"](_ref, _excluded);
  var boundRunSaga;
  {
  ...
  function sagaMiddleware(_ref2) {
    ...
    boundRunSaga = runSaga.bind(null, _extends["default"]({}, options, {
      context: context,
      channel: channel,
      dispatch: dispatch,
      getState: getState,
...
Object.defineProperty(exports, 'CANCEL', {
  enumerable: true,
  get: function () { return symbols.CANCEL; }
});
Object.defineProperty(exports, 'SAGA_LOCATION', {
  enumerable: true,
  get: function () { return symbols.SAGA_LOCATION; }
});
